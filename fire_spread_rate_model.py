...
preprocessor = ColumnTransformer(
    transformers=[
        ('unorder_cat', OneHotEncoder(), ['weather_conditions_over_fire', 'general_cause_desc']),
...
linear_cv_scores = cross_val_score(linear_model, X.copy(), y, cv=40, scoring='neg_root_mean_squared_error')
linear_itr1_cv_scores = cross_val_score(linear_model_itr1, X_itr1.copy(), y, cv=40, scoring='neg_root_mean_squared_error')
